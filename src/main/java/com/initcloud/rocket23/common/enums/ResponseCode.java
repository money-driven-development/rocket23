...
public enum ResponseCode {
    ...
    SERVER_CREATED_DIR_ERROR(5003, HttpStatus.INTERNAL_SERVER_ERROR, "Could not create upload directory"),

    SERVER_STORE_ERROR(5004, HttpStatus.INTERNAL_SERVER_ERROR, "Could not store the file"),
