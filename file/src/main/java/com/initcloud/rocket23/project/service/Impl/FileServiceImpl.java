...
public class FileServiceImpl implements FileService {
    ...
    public void store(MultipartFile file) {
        try {
            ...
            storeFile(file, root, uuid, isZipFile);
        } catch (IOException e) {
     ...
     */
    @Override
    public void storeFile(MultipartFile file, Path path, String uuid, boolean isZipFile) throws IOException {
        if (isZipFile) {
            unZip(file, path);
        } else {
        ...
        save(file, ServerType.LOCAL, uuid, path.toString());
    }
     ...
     */
    @Override
    public void save(MultipartFile file, ServerType type, String uuid, String uploadPath) {
        redisMessagePublisher.publishFileMessage(
                new RedisFileDto(uuid, file.getOriginalFilename())
        );
    }
