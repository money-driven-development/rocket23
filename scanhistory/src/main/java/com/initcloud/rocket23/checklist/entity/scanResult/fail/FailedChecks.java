...
//@Getter
//@Entity
//@Table(name = "FAILED_CHECKS")
//@NoArgsConstructor(access = AccessLevel.PROTECTED)
//@JsonNaming(value = PropertyNamingStrategy.SnakeCaseStrategy.class)
//public class FailedChecks {
//
//    @Id
//    @Column(name = "failed_checks_id")
...
//     */
//    @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "failedChecks")
//    private List<FailedCodeBlock> codeBlock;
//
//    @OneToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "failedChecks")
//    private FailedCheckResult checkResult;
//
...
//
//    @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "failedChecks")
//    private List<FailedFileLineRange> fileLineRange;
//
//    @Column
...
//
//    public FailedChecks(Results results, String checkId, String bcCheckId, String checkName,
//                        List<FailedCodeBlock> codeBlock, FailedCheckResult checkResult, String filePath,
//                        String fileAbsPath,
//                        String repoFilePath, List<FailedFileLineRange> fileLineRange, String resource,
//                        String evaluations,
//                        String checkClass, String fixedDefinition, String entityTags, String callerFilePath,
//                        String callerFileLineRange, String resourceAddress, String severity, String bcCategory,
//                        String benchmarks, String description, String shortDescription, String vulnerabilityDetails,
//                        String connectedNode, String guideline, List details, String checkLen,
//                        String definitionContextFilePath) {
