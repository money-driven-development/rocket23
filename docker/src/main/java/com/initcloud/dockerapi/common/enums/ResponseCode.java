...
public enum ResponseCode {
	...
	DOCKER_CANNOT_READ_SCAN_OUTPUT(4306, HttpStatus.BAD_REQUEST, "스캔 결과를 읽을 수 없습니다."),
	DOCKER_CANNOT_PARSE_SCAN_TO_JSON(4307, HttpStatus.BAD_REQUEST, "JSON 응답을 생성할 수 없습니다."),

	/**
	 * Server Common, Exception Error
	 * 50xx ~ 51xx
	 */
	SERVER_BUSY(5001, HttpStatus.INTERNAL_SERVER_ERROR, "서버가 바쁩니다. 잠시 후 다시 시도해주세요."),

	SERVER_ERROR(5002, HttpStatus.INTERNAL_SERVER_ERROR, "서버가 요청을 처리할 수 없습니다."),
